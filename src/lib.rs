...
impl Unpoly {
    ...
    pub fn set_evict_cache(&mut self, cache: impl Into<String>) {
        self.response_evict_cache = Some(cache.into());
    }

    pub fn set_expire_cache(&mut self, cache: impl Into<String>) {
        self.response_expire_cache = Some(cache.into());
    }
